...
public class FastJsonAutoConfiguration {
    ...
    protected static class FastJson2HttpMessageConverterConfiguration {
        ...
        public HttpMessageConverters customConverters(MyFastJsonHttpMessageConverter converter) throws IllegalAccessException, InstantiationException {
            ...
            if (null == converter) {
                ...
                converter = (MyFastJsonHttpMessageConverter) converterClass.newInstance();
