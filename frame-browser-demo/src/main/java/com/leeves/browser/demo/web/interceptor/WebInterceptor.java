...
/**
 * Description: 拦截器
 * Package: com.leeves.demo.web.interceptor
 *
 * @author Leeves
...
public class WebInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        request.setAttribute("interceptor_time", System.currentTimeMillis());
        return true;
    }
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        System.out.println("postHandle time:" + (System.currentTimeMillis() - startTime) + "ms");
    }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        ...
        Long startTime = (Long) request.getAttribute("interceptor_time");
        System.out.println("afterCompletion time:" + (System.currentTimeMillis() - startTime) + "ms");
    }
}